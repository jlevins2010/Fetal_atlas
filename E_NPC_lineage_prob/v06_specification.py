...
df.to_csv('/home/levinsj/Fetal_dir/Velocyto/03_CellRank/specification_absorbtion_probabilities.csv', index=False)
...
df.to_csv('/home/levinsj/Fetal_dir/Velocyto/03_CellRank/NephroLineageDrivers_specification.csv')  
df = pd.read_csv("/home/levinsj/Fetal_dir/Velocyto/03_CellRank/NephroLineageDrivers_specification.csv")
TFs = pd.read_csv("/home/levinsj/Applications/TFs_hg38.txt", header=None)
TF_df = df[df["Unnamed: 0"].isin(TFs[0])]
TF_df.to_csv('/home/levinsj/Fetal_dir/Velocyto/03_CellRank/NephroLineageDrivers_specification_TFs.csv') 

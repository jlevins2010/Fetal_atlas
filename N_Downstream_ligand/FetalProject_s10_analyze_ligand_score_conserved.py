...
sc.pp.neighbors(adata_merge, n_neighbors = 30, n_pcs=30)
sc.tl.umap(adata_merge, min_dist = 0.4)
sc.tl.leiden(adata_merge, resolution = 0.3)
sc.pl.umap(adata_merge, color = "sample", legend_fontsize=10, legend_fontoutline=2, frameon = False)
sc.pl.umap(adata_merge, color = "leiden", legend_fontsize=10, legend_fontoutline=2, frameon = False)
...
sc.pl.umap(adata_merge, color = ["VEGFA","AVP","RSPO3","GDNF"], cmap = "viridis_r", legend_fontsize=10, legend_fontoutline=2, frameon = False)
